              ...
              {moduleOpen('pos') && (
                ...
                },
                {
                  ...
                  tips: [
                    ...
                    'Guest QR self-ordering (Pro plan): with this enabled, the guest menu also lets the customer add items and submit their own order — it never goes straight to the kitchen. It lands as a request a staff member must Accept (or Dismiss) from Order Taking first, so nothing gets cooked without a human check. The guest sees their request go from "waiting for confirmation" to "confirmed by staff" once accepted',
                ...
                },
                {
                  ...
                  tips: [
                    ...
                    'Guest QR self-ordering (Pro plan): if enabled for your restaurant, a 🔔 Guest order badge appears on a table when a guest submits an order from their phone via the QR menu. Open that table to see exactly what they ordered — Accept adds those items straight into your cart at the quantities they chose (adjust or add more before sending), Dismiss discards the request with no effect on the order. Nothing reaches the kitchen until you actually press Send Order/KOT, same as any item you add yourself. Enable it per client in Admin → Manage Clients → Features',
                  ],
                },
                {
