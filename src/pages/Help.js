              ...
              {moduleOpen('pos') && (
                ...
                },
                {
                  ...
                  tips: [
                    ...
                    'Guest QR self-ordering (Pro plan): with this enabled, the guest menu also lets the customer add items, pick how many are dining, and submit their own order — it never goes straight to the kitchen. It lands as a request a staff member must Accept (or Dismiss) from Order Taking first, so nothing gets cooked without a human check. The guest sees a status card with exactly what they ordered, tracking through Placed → Confirmed → Sent to Kitchen → Preparing → Ready as staff progresses it',
