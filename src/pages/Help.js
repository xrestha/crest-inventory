...
const HR_FEATURES = [
  ...
  {
    icon: '⚙', name: 'Pay Setup',
    guide: 'Configure and review salary, allowances, deductions, SSF, and bank details for every employee — all in one place. Click any employee row to open the Pay Setup form with two tabs: Salary (pay basis, basic, allowances, deductions, SSF auto-row, net summary) and Bank/SSF (bank name, account, branch, SSF number). The summary table shows Basic / Allowances / Gross / Deductions / Net / Employer SSF for all employees, plus payroll totals and an Excel export. Daily and hourly staff show their configured rate; their actual pay is computed from attendance during the Payroll run.',
    tips: ['Set Pay Basis to Monthly for salaried staff, or Daily / Hourly for wage workers — daily/hourly pay is calculated later from attendance in Payroll', 'SSF is computed on basic salary capped at NPR 100,000 — the cap is applied automatically', 'Minimum wage is NPR 19,550/month (12,170 basic) for full-time staff, NPR 754/day, or NPR 101/hour (107 part-time) — a warning appears below the minimum', 'Nepal Labour Act requires basic salary to be at least 60% of gross — an amber warning appears if it is lower', 'Use "Split from gross salary" to enter a total figure and auto-split it into basic and allowances', 'Employer SSF (20%) is paid by the company and is not deducted from the employee\'s net salary', 'Bank details added here flow into payroll — employees without a bank account show an amber warning', 'Income tax / TDS is not deducted here yet — it will arrive in a future Crest HR update']
  },
  {
